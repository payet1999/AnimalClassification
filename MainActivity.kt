...
class MainActivity : AppCompatActivity() {
    ...
    private fun predictAnimal() {
        imageToPredict?.let { rawBitmap ->
            ...
            Log.d("Required shape", TensorImage.fromBitmap(bitmap).buffer.toString())
            Log.d("Given shape", inputFeature0.buffer.toString())
            ...
            Log.d("array output", maxVal.toString())
            for (value in outputFeature0.floatArray) {
                Log.d("Output values", value.toString())
            }
